package com.senon.mvpretrofitrx.mvp.permission;
...
public class PermissionUtils {
    ...
    private static int NOT_NOTICE = 2;//如果勾选了不再询问
    ...
    //权限集合
    //访问相机
    public final String[] PREMISSIONS_TAKE_PHOTO = new String[]{
    ...
    //内存的读写权限
    public final String[] PREMISSIONS_EXTERNAL_STORAGE = new String[]{
            Manifest.permission.WRITE_EXTERNAL_STORAGE,
            Manifest.permission.READ_EXTERNAL_STORAGE,
    ...
    //只有内存的读写权限
    public final String[] PREMISSIONS_EXTERNAL_STORAGE_ONLY = new String[]{
            Manifest.permission.WRITE_EXTERNAL_STORAGE,
            Manifest.permission.READ_EXTERNAL_STORAGE,
    };
    ...
    //访问通讯录
    public final String[] PREMISSIONS_GET_ACCOUNTS = new String[]{
    ...
    //拨打电话
    public static final String[] PERMISSIONS_MAKECALL = new String[]{
    ...
    //访问录音机
    public final String[] PERMISSIONS_RECORD = new String[]{
            Manifest.permission.RECORD_AUDIO
    };


    //开启音视频
    public final String[] PERMISSIONS_AVCHAT = new String[]{
            Manifest.permission.RECORD_AUDIO,
            Manifest.permission.CAMERA,
            Manifest.permission.WRITE_EXTERNAL_STORAGE,
            Manifest.permission.READ_EXTERNAL_STORAGE,
