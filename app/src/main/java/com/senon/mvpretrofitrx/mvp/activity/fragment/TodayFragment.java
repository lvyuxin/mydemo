...
import com.senon.mvpretrofitrx.mvp.adapter.TodayNewsadapter;
...
import com.senon.mvpretrofitrx.mvp.presenter.FragmentNewPresenter;
...
public class TodayFragment extends BaseFragment<Fragment_TwoC.View,
    ...
    Unbinder unbinder;
    private List<itemNews> listBean = new ArrayList<>();
    ...
    public void init() {
        ...
        adapter = new TodayNewsadapter(R.layout.item_wx, listBean);
...
//        getPresenter().getTodayNews(map, true, false);
        Log.i(tag, "000000---vvvv--");
//        initRefresh();
    }
    ...
    @Override
    public void result(BaseResponse<List<itemNews>> data,boolean  next) {
        Log.i(tag,"size vvvv "+data.getData().size());
        if (page == 1) {
    ...
    private void initRefresh() {
        mRefreshLayout.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                map.put("kw", "nba");
                map.put("apikey", "wZDZBjbnz7P7CPHhH3OOIxRM2nAMzf4mzJVH9kLMdNZS5dWrByRCZND1ZRfT6p4T");
                getPresenter().getTodayNews(map, false, true);
            }
        });
    }
