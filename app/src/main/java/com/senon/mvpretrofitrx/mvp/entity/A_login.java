...
public class A_login {
    ...
    /**
     * errorCode : 0
     * data : {"chapterTops":[],"collectIds":[7700,7960,7969],"email":"","icon":"","id":11144,"password":"","token":"","type":0,"username":"13527491943"}
     * errorMsg :
     */
