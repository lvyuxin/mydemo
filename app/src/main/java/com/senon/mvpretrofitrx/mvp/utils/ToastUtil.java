...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        showCustomToast(ApplicationUtil.getApplication(), msg, Toast.LENGTH_SHORT);
    }

    public static void showShortToast(int msgId) {
        showCustomToast(ApplicationUtil.getApplication(), msgId, Toast.LENGTH_SHORT);
    }

    public static void showLongToast(String msg) {
        showCustomToast(ApplicationUtil.getApplication(), msg, Toast.LENGTH_LONG);
    }

    public static void showLongToast(int msgId) {
        showCustomToast(ApplicationUtil.getApplication(), msgId, Toast.LENGTH_LONG);
    }
